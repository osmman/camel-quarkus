 ...
 * Health.
 */
public class CamelQuarkusMicroProfileHealthCheckRegistry extends DefaultHealthCheckRegistry implements StartupListener {

    public static final String CONSUMERS_CHECK_NAME = "camel-consumers";
    public static final String ROUTES_CHECK_NAME = "camel-routes";
    private static final Logger LOG = LoggerFactory.getLogger(CamelQuarkusMicroProfileHealthCheckRegistry.class);
